...
public class DefaultMapLoader {
	...
	switch (id) {
	case HK1:
	    teams.add(new DTMTeam(pl, "yellow", "Keltainen", ChatColor.YELLOW,
		    new WorldlessLocation(0.5, 100.0, -55.5, 0, 0), getMonuments(id, DefaultTeamID.YELLOW)));
	    teams.add(new DTMTeam(pl, "purple", "Purppura", ChatColor.DARK_PURPLE,
		    new WorldlessLocation(0.5, 100.0, 56.5, 180, 0), getMonuments(id, DefaultTeamID.PURPLE)));
	    break;
	case HK2:
	    teams.add(new DTMTeam(pl, "yellow", "Keltainen", ChatColor.YELLOW,
		    new WorldlessLocation(0.5, 100.0, 51.5, 180, 0), getMonuments(id, DefaultTeamID.YELLOW)));
	    teams.add(new DTMTeam(pl, "purple", "Purppura", ChatColor.DARK_PURPLE,
		    new WorldlessLocation(0.5, 100.0, -50.5, 0, 0), getMonuments(id, DefaultTeamID.PURPLE)));
	    break;
	case HK3:
	    ...
	    teams.add(new DTMTeam(pl, "aurinko", "Aurinko", ChatColor.GOLD,
		    new WorldlessLocation(-54.5, 100, 0.5, 270, 0), getMonuments(id, DefaultTeamID.AURINKO)));

	    break;
	case HK4:
	    teams.add(new DTMTeam(pl, "mansikka", "Mansikka", ChatColor.RED,
		    new WorldlessLocation(0.5, 101.0, -64.5, 0, 0), getMonuments(id, DefaultTeamID.MANSIKKA)));
	    teams.add(new DTMTeam(pl, "mustikka", "Mustikka", ChatColor.DARK_PURPLE,
