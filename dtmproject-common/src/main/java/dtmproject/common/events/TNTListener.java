...
public class TNTListener implements Listener {
	...
	world.spawnParticle(Particle.BLOCK_CRACK, entity.getLocation(), 100, 1, 1, 1,
	...
	event.blockList().forEach(block -> {
	    ...
	    velocity.setY(velocity.getY() > 0 ? velocity.getY() + randomInt(0, 50) / 100.0
		    : (-1 * velocity.getY()) + randomInt(0, 50) / 100.0);
